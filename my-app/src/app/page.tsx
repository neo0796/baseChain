...
const Home: FC = () => {
    ...
    return (
        <div
            className="h-[220vh] bg-gradient-to-br from-green-900 to-black relative overflow-hidden"
            style={{
                backgroundImage: `url(https://img.freepik.com/premium-vector/abstract-background-with-green-technology-structure-circuit-computer_518299-1554.jpg)`,
            ...
            <div className="flex h-[100vh] pt-24">
                ...
                <div ref={heroRef} className="w-2/3 flex flex-col items-center justify-center text-center px-6">
                    <h1 className="text-7xl font-extrabold text-white shadow-md">
                        Unlock the power of base chains—your AI assistant for seamless blockchain insights!
                    </h1>
                </div>

                {/* Chatbot - Fixed Position with Reduced Height */}
                <div className="fixed right-8 bottom-8 w-[420px] h-[calc(100%-6rem-30px)] rounded-lg p-6 flex flex-col bg-black bg-opacity-90 backdrop-blur-lg border border-green-600 shadow-lg"
                    style={{
                    ...
                    <div className="flex items-center">
                        ...
                        <div className="ml-2">
                            <button
                                ...
                                className="bg-gradient-to-r from-green-400 to-green-600 text-white px-4 py-3 rounded-lg transition-transform duration-200 transform hover:scale-105 flex items-center"
                            >
            ...
            <div ref={descriptionRef} className="absolute w-1/2 mx-auto top-[80vh] left-16 p-6">
                ...
                >
                    ...
                    <p className="mt-4 text-xl leading-relaxed text-gray-300">
                        This base chain assistant app is designed to simplify the complexities of foundational blockchain technology, offering an interactive and personalized learning experience. With an AI-powered chatbot, users can explore core concepts, ask questions, and receive instant explanations tailored to their understanding.
                        <br />
                        <br />
                        Example prompts include:
                        <br />
                        <br />
                        👉“What is a base chain and how does it work?”<br />
                        👉“Can you explain the differences between various base chains?”<br />
                        👉“How do base chains ensure security and scalability?”<br />
                        👉“What are some popular use cases for base chains?”<br />
                        👉“How can I interact with smart contracts on a base chain?”<br />
                        👉“What should I know about transaction fees on different base chains?”<br />
                        <br />
                        This app aims to make base chains accessible and engaging, breaking down barriers to understanding while fostering a passion for blockchain technology. By leveraging AI to provide immediate support and resources, it empowers users to enhance their knowledge and confidence in utilizing base chains, paving the way for successful blockchain endeavors.
                    </p>
                </div>
            </div>
